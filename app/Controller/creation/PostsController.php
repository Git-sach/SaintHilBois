...
class PostsController extends \app\Controller\AppController{
    ...
    public function index(){
        ...
        $svgMoins = '<svg width="27" height="21" viewBox="0 0 27 21" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        $svgPlus = '<svg width="27" height="21" viewBox="0 0 27 21" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        if(isset($_GET['page'])) {
            ...
            $moins = $page-1;
            if($page<$nbrPages){
                $pagePlus = "<a href='/index.php?p=creation.posts.index&page=" . $plus . "'> $svgPlus </a>";
                $plus1 = "<a href='/index.php?p=creation.posts.index&page=" . $plus . "'>" . $plus . "</a>";
            }
            else{
                $pagePlus = '';
                $plus1 = '';
            ...
            if($page>1){
                $pageMoins = "<a href='/index.php?p=creation.posts.index&page=" . $moins . "'> $svgMoins </a>";
                $moins1 = "<a href='/index.php?p=creation.posts.index&page=" . $moins . "'>" . $moins . "</a>";
            }
            else{
                $pageMoins = '';
                $moins1 = '';
        ...
        $this->render('creation.posts.index', compact('posts', 'form', 'pageMoins', 'pagePlus', 'moins1', 'plus1', 'courant'));
